...
// The PHP code
	...
	if ($fail == "")
	{
	echo "</head><body>Form data successfully validated at the server:
	$forename, $surname, $username, $password, $age, $email.</body></html>";
	// These value now can be stored into a database
	exit;
	}
	echo <<<_END
...
<!-- The HTML section -->
	...
	<body>
		<table border="0" cellpadding="2" cellspacing="5" bgcolor="#eeeeee">
			...
			in your form at the server: <p><font color=red size=1><i>$fail</i></font></p>
			</td></tr>
			<form method="post" action="http://localhost/APP2000/Lecture13/addUser.php" onSubmit="return validate(this)">
				<tr><td>Forename</td>
